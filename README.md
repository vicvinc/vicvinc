<img src="https://capsule-render.vercel.app/api?type=waving&height=140&section=header&text=vicvinc&fontSize=46&fontColor=ffffff&color=0:0f1f3d,100:2d4f7c&desc=write%20code%20%C2%B7%20automate%20everything%20%C2%B7%20share%20on%20the%20internet&descSize=15&descAlignY=68" width="100%"/>

**把想法变成能跑起来的系统。**

长期关注 Web 工程、自动化与 AI Agent 工作流；现在更多时间花在 MCP、Codex、OpenClaw 和本地 Agent 协作实验上。

[![Blog](https://img.shields.io/badge/blog-vicvinc.github.io-2D4F7C?style=flat-square)](https://vicvinc.github.io)
[![Focus](https://img.shields.io/badge/focus-AI_Agent_Workflows-4C89C8?style=flat-square)](#精选项目)
![Location](https://img.shields.io/badge/base-Beijing-0F1F3D?style=flat-square)

## 现在在做

- 用 **AI-assisted development** 重整个人开发流程，让重复工作交给 Agent 和自动化任务。
- 探索 **MCP 工具链**、Agent 编排、prompt engineering 和设计工程。
- 持续在 [vicvinc.github.io](https://vicvinc.github.io) 记录实践与观察，写作从 2016 年到现在没有停。
- Fun fact：我的 cron jobs 比我自己还忙。

## 精选项目

| 项目 | 说明 | 技术 |
| --- | --- | --- |
| [utox-agent-communication](https://github.com/vicvinc/utox-agent-communication) | 基于 Tox 协议的 AI Agent 去中心化端到端加密通信方案，让本地 Agent 通过 P2P 直连对话。 | Python, Tox, E2EE |
| [html2image-mcp](https://github.com/vicvinc/html2image-mcp) | 为 AI 智能体提供 HTML 转图片和网页截图能力的 MCP Server。 | Node.js, MCP, Puppeteer |
| [sipParser](https://github.com/vicvinc/sipParser) | SIP 日志解析工具。 | Python, JavaScript |
| [vmall](https://github.com/vicvinc/vmall) | 轻量微信公众号商城，支持支付与后台订单管理。 | PHP, WeChat Pay |

## 技术栈

**🤖 AI-Native 开发**

**智能体** · ![OpenClaw](https://img.shields.io/badge/OpenClaw-2D4F7C?style=flat-square) ![Claude Code](https://img.shields.io/badge/Claude_Code-D97757?style=flat-square&logo=claude&logoColor=white) ![Codex](https://img.shields.io/badge/Codex-412991?style=flat-square&logo=openai&logoColor=white) ![ZCode](https://img.shields.io/badge/ZCode-4C89C8?style=flat-square)
...
**[vicvinc.github.io](https://vicvinc.github.io)** · write code, automate everything, share on the internet.
...
<img src="https://capsule-render.vercel.app/api?type=waving&height=100&section=footer&color=0:0f1f3d,100:2d4f7c" width="100%"/>
